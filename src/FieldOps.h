...
class FieldOpsClass {
  ...
  public:
    ...
    bool checkHex(const char *StringToCompare, uint16_t MaximumFieldLength);
    ...
    bool compareHex(uint16_t InputBufferLength, uint16_t MaximumFieldLength, const char *InputBuffer, uint32_t MinimumValue, uint32_t MaximumValue, uint16_t FieldNumber, uint8_t SeparatorType, uint8_t TerminatorType);
    int32_t extractInt(uint16_t InputBufferLength, uint16_t MaximumFieldLength, const char *InputBuffer, uint16_t FieldNumber, uint8_t SeparatorType, uint8_t TerminatorType);
    float extractFloat(uint16_t InputBufferLength, uint16_t MaximumFieldLength, const char *InputBuffer, uint16_t FieldNumber, uint8_t SeparatorType, uint8_t TerminatorType);
    uint32_t extractHex(uint16_t InputBufferLength, uint16_t MaximumFieldLength, const char *InputBuffer, uint16_t FieldNumber, uint8_t SeparatorType, uint8_t TerminatorType);
